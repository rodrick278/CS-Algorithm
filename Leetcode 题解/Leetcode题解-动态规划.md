...
2. 7 > 4 ①down数组加上这个数变成up数组：[1,7] ②替换up数组的最后一个上升的值 [1,7]。选谁都行。
...
3. 2 < 7 ①up数组加上这个数变成down数组：[1,7,4] ②替换down数组的最后一个下降的值 [2]。我们选择前者。
...
4. 5 > 2 ①down数组加上这个数变成up数组：[1,7,5] ②替换up数组的最后一个上升的值 [1,7,5]。选谁都行。
